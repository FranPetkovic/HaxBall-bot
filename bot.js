...
let boje = ["e71d43", "ff0000", "ff3700", "ff6e00", "ffa500", "ffc300", "ffe100", "ffff00", "aad500", "55aa00", "008000", "005555", "002baa", "0000ff", "1900d5", "3200ac", "4b0082", "812ba6", "b857ca", "d03a87"]
let bojeT = ["e71d43", "ff0000", "ff3700", "ff6e00", "ffa500", "ffc300", "ffe100", "ffff00", "aad500", "55aa00", "008000", "005555", "002baa", "0000ff", "1900d5", "3200ac", "4b0082", "812ba6", "b857ca", "d03a87"]
let boje2=bojeT.reverse()
let brojac = 0
const room = HBInit({
    roomName: roomName,
...
function Game(date, scores, goals) {
    ...
    intervalId = setInterval(function() {
        ...
        if (brojac === 19) {
            room.setTeamColors(team.BLUE, 69, 0xFFFFFF, ["0x" + boje[brojac], "0x" + boje[0], "0x" + boje[1]])
            room.setTeamColors(team.RED, 69, 0xFFFFFF, ["0x" + boje2[brojac], "0x" + boje2[brojac + 1], "0x" + boje2[brojac + 2]])
        } else if (brojac === 18) {
            room.setTeamColors(team.BLUE, 69, 0xFFFFFF, ["0x" + boje[brojac], "0x" + boje[19], "0x" + boje[0]])
            room.setTeamColors(team.RED, 69, 0xFFFFFF, ["0x" + boje2[brojac], "0x" + boje2[brojac + 1], "0x" + boje2[brojac + 2]])

        } else {
            room.setTeamColors(team.BLUE, 69, 0xFFFFFF, ["0x" + boje[brojac], "0x" + boje[brojac + 1], "0x" + boje[brojac + 2]])
            room.setTeamColors(team.RED, 69, 0xFFFFFF, ["0x" + boje2[brojac], "0x" + boje2[brojac + 1], "0x" + boje2[brojac + 2]])
        }
        brojac++
    }, 100);
